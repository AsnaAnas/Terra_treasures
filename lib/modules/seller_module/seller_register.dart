...
class SellerRegisterPage extends StatefulWidget {
  ...
  @override
  State<SellerRegisterPage> createState() => _RegisterScreenState();
}

class _RegisterScreenState extends State<SellerRegisterPage> {
    ...
    if (_formkey.currentState!.validate()) {
      ...
      try {
        ...
        final sellerModel = SellerModel(
          ...
          street:_placeController.text
        );

        await controller.addUser(sellerModel, uid);
