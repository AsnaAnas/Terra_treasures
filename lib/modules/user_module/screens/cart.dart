...
class _CartPageState extends State<Cart> {
  ...
  Future<void> fetchCartItems() async {
    FirebaseFirestore.instance
      ...
      for (var cartItem in snapshot.docs) {
        ...
        if (productData != null) {
          newItemPrices[productId] = productData["price"].toDouble();
          newTotal += qty * productData["price"].toDouble();
        }
      }
  ...
  Future<DocumentSnapshot<Map<String, dynamic>>> getProductDetails(String productId) {
    return FirebaseFirestore.instance.collection('product').doc(productId).get();
  }
  ...
  Future<DocumentSnapshot<Map<String, dynamic>>> getSellerDetails(String userId) {
    return FirebaseFirestore.instance.collection("").doc(userId).get();
  }
